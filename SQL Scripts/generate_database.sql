...
create table
  diagnosis (
    ...
    summary text,
    fk_appointment_id int references appointment
  );
...
create table
  diagnosis_disease (
    ...
    disease_id int not null references diagnosis,
    add_or_remove not null boolean,
...
create table
  diagnosis_medication (
    diagnosis_id int not null references diagnosis
    medication_id int not null references diagnosis,
    add_or_remove not null boolean,
