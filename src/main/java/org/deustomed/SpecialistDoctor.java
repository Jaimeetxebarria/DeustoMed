...
public class SpecialistDoctor extends Doctor {
    ...
    public SpecialistDoctor(int id, String name, String surname1, String surname2, String email, String password, String dni, Sex sex, String speciality, ArrayList<Appoinment> appointments, ArrayList<Patient> treatedPatients, ArrayList<Patient> toTreatPatients, ArrayList<Patient> inTreatmentPatients) {
