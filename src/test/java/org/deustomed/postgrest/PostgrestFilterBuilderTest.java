...
class PostgrestFilterBuilderTest {
    ...
    void eq() {
        ...
        assertEquals("?column=eq.null", getPathname(new PostgrestFilterBuilder().eq("column", null)));
    ...
    void neq() {
        ...
        assertEquals("?column=neq.null", getPathname(new PostgrestFilterBuilder().neq("column", null)));
    ...
    void lt() {
        ...
        assertEquals("?column=lt.null", getPathname(new PostgrestFilterBuilder().lt("column", null)));
    ...
    void gt() {
        ...
        assertEquals("?column=gt.null", getPathname(new PostgrestFilterBuilder().gt("column", null)));
    ...
    void gte() {
        ...
        assertEquals("?column=gte.null", getPathname(new PostgrestFilterBuilder().gte("column", null)));
    ...
    void lte() {
        ...
        assertEquals("?column=lte.null", getPathname(new PostgrestFilterBuilder().lte("column", null)));
    ...
    void like() {
        ...
        assertEquals("?column=like.null", getPathname(new PostgrestFilterBuilder().like("column", null)));
    ...
    void ilike() {
        ...
        assertEquals("?column=ilike.null", getPathname(new PostgrestFilterBuilder().ilike("column", null)));
    ...
    void not() {
        ...
        assertEquals("?column=not.lt.null", getPathname(new PostgrestFilterBuilder().not().lt("column", null)));
