...
public class WeekDayFinderTest {
    ...
    void testFindNextDay_SameDay() {
        ...
        LocalDate actual = finder.findNextDay(todayDayOfWeek, today);
    ...
    void testFindNextDay_NextWeek() {
        ...
        LocalDate actual = finder.findNextDay(yesterdayDayOfWeek, today);
    ...
    void testFindNextDay_InvalidDay() {
        WeekDayFinder finder = new WeekDayFinder();
        LocalDate today = LocalDate.now();
        assertThrows(IllegalArgumentException.class, () -> finder.findNextDay("InvalidDay", today), "Should throw IllegalArgumentException for invalid day of week");
    }
    ...
    void testFindNextDay_EndOfWeek() {
        ...
        LocalDate actual = finder.findNextDay(nextDayOfWeek, lastDayOfWeek);
    ...
    void testFindNextDay_NearFutureDay() {
        ...
        LocalDate actual = finder.findNextDay(nextDayOfWeek, today);
