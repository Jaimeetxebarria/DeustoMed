...
drop table if exists appointment_has_diagnosis;
create table
...
drop table if exists doctor_performs_surgery;
create table
...
drop table if exists patient_undergoes_surgery;
create table
...
drop table if exists patient_suffers_disease;
create table
